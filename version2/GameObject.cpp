...
void GameObject::save(ofstream& file){
  file << this->id_num << " " << this->location.x << " " << this->location.y << " " << this->display_code << " " << this->state; 
}
