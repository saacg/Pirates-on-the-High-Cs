...
// default constructor
Sailor::Sailor(char display_char, Model* world):GameObject(display_char, 0){
  this->world = world;
  state = 'a';
  health = 25;
 // size = 15;
...
// constructor
Sailor::Sailor(char display_char, int in_id, Dock* hideout, Model* world):GameObject(display_char, in_id, hideout->location){
...
Sailor::Sailor(char display_char, int in_id, CartPoint location, Model* world):GameObject(display_char, in_id, location){
  this->hideout = NULL;
  this->dock = NULL;
  this->world = world;
  this->state = 'a';
...
void Sailor::start_hiding(){
  ...
  this->state = 'h';
  cout << "Sailor " << this->get_id() << " hiding " << this->hideout->get_id() << endl;
...
// prints out plunder fail message
...
void Sailor::save(ofstream& file){
  ...
  file << " " << this->health << " " << this->size << " " << this->preSize << " " << this->hold << " " << this->cargo << " "
       << this->destination.x << " " << this->destination.y << " " << this->delta.x << " " << this->delta.y << " ";

  if(!(this->port)){
    file << nullPtr << " ";
  }
  else{
    file << this->port->get_id() << " ";
  }
